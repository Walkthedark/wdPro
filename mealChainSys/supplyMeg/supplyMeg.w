  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-title" xid="title2"><![CDATA[九台路-采购管理]]></div>  
        ...
        <div xid="div9" class="list-group-item"> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col20"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="审核中" xid="button17" style="width:60px;color:#737373;"> 
                <i xid="i17"/>  
                <span xid="span27">审核中</span>
              </a> 
            </div>  
            <div class="x-col" xid="col19"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="未确认" xid="button24" style="width:60px;color:#737373;"> 
                <i xid="i24"/>  
                <span xid="span26">未确认</span>
              </a> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col21"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="已收单" xid="button26" style="width:60px;color:#737373;"> 
                <i xid="i26"/>  
                <span xid="span30">已收单</span>
              </a> 
            </div>  
            <div class="x-col" xid="col23"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="已配货" xid="button27" style="width:60px;color:#737373;"> 
                <i xid="i25"/>  
                <span xid="span28">已配货</span>
              </a> 
            </div>  
            <div class="x-col" xid="col22"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="收货中" xid="button25" style="width:60px;color:#737373;"> 
                <i xid="i27"/>  
                <span xid="span29">收货中</span>
              </a> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col24"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="已完成" xid="button29" style="width:60px;color:#737373;"> 
                <i xid="i29"/>  
                <span xid="span33">已完成</span>
              </a> 
            </div>  
            <div class="x-col" xid="col26"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="已取消" xid="button30" style="width:60px;color:#737373;"> 
                <i xid="i28"/>  
                <span xid="span31">已取消</span>
              </a> 
            </div>  
            <div class="x-col" xid="col25"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color" label="已过期" xid="button8" style="width:60px;color:#737373;">
   <i xid="i5"></i>
   <span xid="span8">已过期</span></a></div> 
          </div>
        </div> 
      </div>
    </div> 
