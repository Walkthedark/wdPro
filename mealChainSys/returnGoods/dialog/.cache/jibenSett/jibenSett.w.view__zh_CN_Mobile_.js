...
var __parent0=require('$model/UI2/mealChainSys/returnGoods/dialog/jibenSett'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cUFvQfm';
	this._flag_='eff2b5a21275a1a3f2b7be51f138a938';
	this._wCfg_={};
	this._appCfg_={};
