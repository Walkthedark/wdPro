...
var __parent0=require('$model/UI2/mealChainSys/theGoods/dialog/receipt'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cAzQbEz';
	this._flag_='be97e3e40381ef7b056224938beee754';
	this._wCfg_={};
	this._appCfg_={};
