...
var __parent0=require('$model/UI2/mealChainSys/theGoods/dialog/dialog/theGoodsOrder'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cQJvaYr';
	this._flag_='3696ed336b8f55570ee9056a65a8b5a9';
	this._wCfg_={};
	this._appCfg_={};
