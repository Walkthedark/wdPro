  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-title" xid="title2"><![CDATA[九台路-合档口]]></div>  
    ...
    <div class="x-panel-content" xid="content1"> 
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        ...
        <div class="x-panel-content" xid="content5" style="background-color:#EEEEEE;">
          ...
          <div xid="div2" class="list-group-item" style="padding:5px 5px 5px 5px;"> 
            <span xid="span9" style="color:#9D9D9D;;margin-left:13px;font-size:12px;"><![CDATA[编号：Sh139234324]]></span>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2" style="padding:0px 0px 0px 0px;">
   <div class="x-col" xid="col6"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-right btn-only-label" label="09/13 09:44" xid="button2" icon="dataControl dataControl-arrowrightl" style="color:#9D9D9D;"> 
                  <i xid="i2" class="dataControl dataControl-arrowrightl" />  
                  <span xid="span2">09/13 09:44</span>
                </a></div>
   <div class="x-col" xid="col7"><h4 class="media-heading" xid="h42" style="text-align:center;"> 
                  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="上海熟食加工厂" xid="button1" icon="icon-beer"> 
                    <i xid="i1" class="icon-beer" style="color:#63C8E7;font-size:18px;" />  
                    <span xid="span1" style="color:#191919;font-size:16px;">上海熟食加工厂</span>
                  </a> 
                </h4></div>
   <div class="x-col" xid="col8" style="text-align:right;"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-right" label="已下单" xid="button3" icon="dataControl dataControl-arrowrightl" style="color:#9D9D9D;" onClick="button3Click"> 
                  <i xid="i3" class="dataControl dataControl-arrowrightl" />  
                  <span xid="span3">已下单</span>
                </a></div></div><span xid="span10" style=" color:#9D9D9D;;margin-left:13px;font-size:12px;"><![CDATA[交货时间：09/13 13:00]]></span></div>  
          </div> 
      </div>
    </div> 
  </div>  
        ...
        <div xid="div9" class="list-group-item"> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col20"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="未收货" xid="button17" style="width:60px;color:#737373;"> 
                <i xid="i17"/>  
                <span xid="span27">未收货</span>
              </a> 
            </div>  
            <div class="x-col" xid="col19"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="收货中" xid="button24" style="width:60px;color:#737373;"> 
                <i xid="i24"/>  
                <span xid="span26">收货中</span>
              </a> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col21"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="已收货" xid="button26" style="width:60px;color:#737373;"> 
                <i xid="i26"/>  
                <span xid="span30">已收货</span>
              </a> 
            </div>  
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col26"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color"
                label="补货中" xid="button30" style="width:60px;color:#737373;"> 
                <i xid="i28"/>  
                <span xid="span31">补货中</span>
              </a> 
            </div>  
            <div class="x-col" xid="col25"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-befo-color" label="已核账" xid="button8" style="width:60px;color:#737373;">
   <i xid="i5"></i>
   <span xid="span8">已核账</span></a></div> 
          </div>
        </div> 
      </div>
    </div> 
       ...
       <div xid="div19" class="list-group-item" style="padding:0px 0px 0px 0px;">
        <div class="media" xid="media1">
         <div class="media-body" xid="mediaBody1">
          <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="供应商(全部)" xid="button5" style="color:#636363;">
           <i xid="i30"></i>
           <span xid="span7">供应商(全部)</span></a> </div> 
