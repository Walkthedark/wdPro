   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input3" style="border-style:none none none none;background-color:white;text-align:right;" placeHolder="上海杨浦区黄兴路217号201" bind-ref='$model.addressData.ref("address")' disabled="true"></input></div></div>
    ...
    <div class="x-panel-bottom" xid="bottom1">
      <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified"
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default"
          label="审核" xid="button2" style="color:#FFFEFF;background-color:#67C9FF;" onClick="button2Click"> 
          <i xid="i2"/>  
...
<div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="popOver1">
  ...
  <div component="$UI/system/components/justep/popMenu/popMenu" class="x-popMenu" direction="right-top" xid="popMenu1" anchor="button1">
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="取消订单" xid="button3" onClick="button3Click">
    <i xid="i3"></i>
    <span xid="span3">取消订单</span></a> </li>
  <li class="x-menu-item" xid="item2">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="修改订单" xid="button9">
    <i xid="i9"></i>
