...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="logData" idColumn="log_id"><column name="log_id" type="String" xid="xid50"></column>
  ...
  <div class="media" xid="media5" style="margin-top:1px;">
   ...
   <div class="media-right" xid="mediaRight4">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs " label="¥88.00" xid="button7" style="color:#545454;font-size:14px;background-color:white;border-style:none none none none;" bind-text='"¥" + $model.orderData.val("price")'>
     <i xid="i7"></i>
     <span xid="span18">¥88.00</span></a> </div> </div></div></div>
  <div xid="div4" style="padding:5px 5px 5px 5px;background-color:#F2F1F2;">
   ...
   <span xid="span24" bind-text='"种类"+$model.goodsData.getCount()'>种类2</span></a>
    ...
    <div xid="div13" style="display:none"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="goodsData">
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li1"><div class="media" xid="media7">
   ...
   <div class="media-body" xid="mediaBody7">
    <h4 class="media-heading" xid="h48"><![CDATA[]]>
  <span xid="span4" style="font-size:16px;color:#242424;" bind-text='val("goods_name")'><![CDATA[]]></span></h4>
  
  <h4 xid="h410" class="media-heading">
   <span xid="span14" style="font-size:14px;color:#888888;" bind-text=' val("goods_type")==""?"":val("goods_type")'></span></h4><h4 xid="h414" class="media-heading">
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list3" data="data2">
   ...
   <span xid="span25" style="font-size:14px;color:#242424;margin-left:7px;" bind-text='"X"+val("num")' class="pull-right"></span></h4><div component="$UI/system/components/justep/row/row" class="x-row" xid="row6" style="padding:0px 0px 0px 0px;">
  ...
  <div xid="div23" style="padding:5px 5px 5px 5px;background-color:#F2F1F2;">
   <div xid="div24" style="background-color:white;padding-right:8px;padding-left:8px;padding-top:3px;">
    <div class="media" xid="media9" style="margin-top:3px;">
     <div class="media-body" xid="mediaBody14">
      <h4 class="media-heading" xid="h417">
       <span xid="span37" style="font-size:16px;color:#545454;margin-left:3px;"><![CDATA[备注]]></span></h4> </div> 
     <div class="media-right" xid="mediaRight5">
      </div> </div> 
    <div class="media" xid="media15" style="margin-top:3px;">
     <div class="media-body" xid="mediaBody16">
      <h4 class="media-heading" xid="h418">
       <span xid="span36" style="font-size:14px;color:#545454;margin-left:3px;" bind-text='$model.orderData.val("order_des")'><![CDATA[]]></span></h4> </div> 
    ...
    <div class="x-panel-bottom" xid="bottom1">
      <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified"
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default"
          label="更多" xid="button1" onClick='{"operation":"popMenu1.show"}'> 
          <i xid="i1"/>  
          <span xid="span1">更多</span>
        </a>  
        <a component="$UI/system/components/justep/button/button" class="btn btn-default"
          label="审核" xid="button2" style="color:#FFFEFF;background-color:#67C9FF;" onClick="button2Click" bind-text=' $model.orderData.val("type_trans")'> 
          <i xid="i2"/>  
          <span xid="span2">审核</span>
        </a> 
      </div>
    </div>
  </div>
<div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="popOver1">
  ...
  <div xid="div16" style="height:100%;width:100%;"><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" style="background-color:#170153;">
   <div class="x-titlebar-left" xid="left1"></div>
   <div class="x-titlebar-title" xid="title1"><![CDATA[状态跟踪]]></div>
   <div class="x-titlebar-right reverse" xid="right1"></div></div></div>
   <div class="x-panel-content" xid="content2" style="background-color:white;"><div xid="div18" style="padding:8px 3px 3px 5px;background-color:#EEEEEE;">
   <ul xid="ul2">
    <div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="logData">
   <ul class="x-list-template" xid="listTemplateUl2">
    <li xid="li3"><li xid="li2" class="li_class2">
     <div xid="div18">
      <div class="media" xid="media16" style="margin-left:2px;">
       <div class="media-body" xid="mediaBody17">
        <h5 xid="h58" class="media-heading" style="font-size:14px;color:#407422;" bind-text=' val("create_at")'><![CDATA[]]></h5>
        <h5 xid="h520" class="media-heading" style="color:#545454;;font-size:14px;" bind-text=' val("operator")'><![CDATA[]]></h5>
  <h5 xid="h51" class="media-heading" style="color:#545454;;font-size:14px;" bind-text=' val("desc")'></h5></div> </div> </div> </li></li></ul> </div> 
    
    
    </ul> 
  </div></div>
   </div></div></div></div>
  <div component="$UI/system/components/justep/popMenu/popMenu" class="x-popMenu" direction="right-top" xid="popMenu1" anchor="button1">
   <div class="x-popMenu-overlay" xid="div17"></div>
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-lg" label="取消订单" xid="button3" onClick="button3Click">
    <i xid="i3"></i>
    <span xid="span3">取消订单</span></a> </li>
  <li class="x-menu-item" xid="item2">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-lg" label="修改订单" xid="button9" onClick="button9Click" bind-visible=' $model.orderData.val("type")==0'>
    <i xid="i9"></i>
    <span xid="span26">修改订单</span></a> </li></ul></div>
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog1" onOK="messageDialog1OK" title="温馨提示" message="确定要取消订单吗？" type="OKCancel"></span>
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="popOver2" anchor="bottom1">
   <div class="x-popOver-overlay" xid="div19"></div>
   <div class="x-popOver-content ddd" xid="div20" style="width:100%;background-color:#F3F4F3;height:180px;">
     ...
     <div class="x-panel-content" xid="content9" style="background-color:#F3F4F3;">
      <div xid="div21" style="padding:5px 5px 5px 5px;">
       <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
        <div class="x-col x-col-80" xid="col11">
         <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea1" style="height:150px;" placeHolder="请输入取消的原因"></textarea></div> 
        <div class="x-col" xid="col12">
         <div xid="div22" style="height:110px;"></div>
         <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="确认" xid="button27" style="color:#FEFFFE;color:#FF9655;" onClick="button27Click">
          <i xid="i27"></i>
          <span xid="span21">确认</span></a> </div> </div> </div> </div> </div> </div> </div></div>
