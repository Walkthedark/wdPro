...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data1" onValueChanged="data1ValueChanged" idColumn="id"><column name="id" type="String" xid="xid59"></column>
  <column name="col1" type="Date" xid="xid60"></column>
  <data xid="default12">[{&quot;id&quot;:&quot;1&quot;}]</data></div></div>  
  ...
  <div xid="div15" style="padding:5px 10px 5px 10px;"><div class="media" xid="media4">
   ...
   <span xid="span20">不开发票</span></a></div> 
     ...
     <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input3" placeHolder="请输入" onBlur="input3Blur"></input>
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input4" placeHolder="请输入" dataType="Float" onBlur="input4Blur"></input>
   ...
   <span xid="span53">现金</span></a></div></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit18">
       ...
       <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input5"  placeHolder="请选择" dataType="Date" min="js:new Date()" bind-ref='$model.data1.ref("col1")'></input></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit20">
