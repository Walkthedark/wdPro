...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:148px;top:20px;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="specificationData" idColumn="id" confirmRefresh="false"> 
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data5" idColumn="uuid" confirmDelete="false" confirmRefresh="false" onCustomRefresh="data5CustomRefresh">
   <rule xid="rule3">
    <col name="fsum" xid="ruleCol3" expr='$model.goodsDataM.sum("fsum")'>
     <calculate xid="calculate3">
      <expr xid="default16">$row.val(&quot;goods_num&quot;)</expr></calculate> </col> 
    <col name="fsumMoney" xid="ruleCol3">
     <calculate xid="calculate3">
      <expr xid="default12">$row.val(&quot;total_price&quot;)</expr></calculate> </col> </rule> 
   ...
   <column name="remark" type="String" xid="column38"></column>
   <column name="unit_id" type="String" xid="column31"></column>
   <column name="uuid" type="String" xid="column56"></column>
   <column name="specification1" type="String" xid="column58"></column>
   <column name="specification2" type="String" xid="column36"></column>
   <column name="specification3" type="String" xid="column37"></column>
   <column name="dis_tag" type="String" xid="column32"></column>
   <column label="促销的价格" name="sales_price" type="Float" xid="column33"></column>
   <column label="是否是促销商品" name="sales_flag" type="String" xid="column34"></column>
   <column label="总价" name="total_price" type="Float" xid="column35"></column>
   <column name="sales_flag_num" type="String" xid="column39"></column>
   <column name="promotion" type="String" xid="column40"></column>
   <column name="promotion_id" type="String" xid="column41"></column></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="sumdata" idColumn="id" confirmRefresh="false">
   ...
   <rule xid="rule3">
    <col name="Value" xid="ruleCol4">
     <calculate xid="calculate4">
      <expr xid="default14">$model.data5.sum(&quot;fsum&quot;)</expr></calculate> </col> 
    <col name="moeny" xid="ruleCol4">
     <calculate xid="calculate4">
      <expr xid="default13">$model.data5.sum(&quot;fsumMoney&quot;)</expr></calculate> </col> </rule> </div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dialogData" idColumn="id">
   <column name="goods_id" type="String" xid="column42"></column>
   <column name="goods_img" type="String" xid="column43"></column>
   <column name="price" type="Double" xid="column44"></column></div></div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card x-has-iosstatusbar"> 
    <div class="x-panel-top" height="48"> 
      <div> 
        <div class="col-xs-10 pull-left tb-nopadding"> 
          <div component="$UI/system/components/justep/button/buttonGroup"
            ...
            <i xid="i13" class="icon-arrow-down-b text-danger" /></a>  
            ...
            <i xid="i8" class="icon-arrow-down-b" /></a> 
          </div> 
        </div>  
      ...
      <div class="col-xs-2 pull-left text-center tb-nopadding"> 
          <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup2"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" xid="listStyleBtn" icon="glyphicon glyphicon-th-list" onClick='{"operation":"window.close"}'> 
    ...
    <div xid="content" class="x-panel-content tb-trans"> 
      <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1" onPullUp="scrollView1PullUp"> 
            <div class="x-scroll-content" xid="div6"> 
              <div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="goodsDataM" limit="10" bind-click="listClick"> 
                <ul class="x-list-template" xid="listTemplateUl1"> 
                  <li xid="li1" class="media" bind-click="li1Click"> 
                    <div xid="div10" class="media-left"> 
                      <img alt="" xid="image1" class="img-rounded media-object" bind-attr-src=" val(&quot;goods_img&quot;)" style="width:75px;" height="80px" /> 
                    </div>  
                    <div class="media-body" xid="div14"> 
                      <h5 class="media-heading lead text-black" xid="h51" style="color:black;font-size:16px;" bind-text=" val(&quot;goods_name&quot;)" />  
                      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="height:2px;"> 
                      ...
                      <div class="text-muted" xid="div15"> 
                        ...
                        <span xid="span9" bind-text=" val(&quot;price&quot;)" class="text-danger" style="font-size:16px;" />  
                        <a component="$UI/system/components/justep/button/button" class="btn x-orange btn-xs pull-right" label="选择格" xid="addCart" style="border-color:#00BFFF #00BFFF #00BFFF #00BFFF;background-color:white;border-style:solid solid solid solid;border-width:thin thin thin thin;color:#00BFFF" bind-visible=' val("set_specs")==1'> 
                          <i xid="i14" />  
                          <span xid="span36">选择格</span> 
                        </a>
                        <div class="tb-numberOperation" xid="div26" style="text-align:right;" bind-visible=' val("set_specs")==0'> 
                          <a component="$UI/system/components/justep/button/button" class="btn x-gray btn-sm btn-only-icon pull-right" label="button" xid="button10" icon="icon-android-add" target="oneColList" bind-click="addZBtnClick"> 
                            <i xid="i22" class="icon-android-add" />  
                            <span xid="span41" />
                          </a>  
                          <span xid="span22" class="pull-right" style="line-height:0.8;height:30px;" bind-text="val(&quot;goods_num&quot;)==null?&quot;0&quot;:val(&quot;goods_num&quot;)" />  
                          <a component="$UI/system/components/justep/button/button" class="btn x-gray btn-sm btn-only-icon pull-right" label="button" xid="button9" icon="icon-android-remove" bind-click="reductionZBtnClick"> 
   ...
   <div xid="div5" style="position:fixed;bottom:75px;right:4px;z-index:999;color:#FFFEFF;text-align:center;height:20px;width:20px;background-color:#FF4026;" align="left" class="btn_radius">
    <span xid="span51" bind-text='$model.sumdata.val("Value")'></span></div> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-default btn_radius" xid="button20" icon="e-commerce e-commerce-gouwuche" style="position:fixed;bottom:60px;right:5px;z-index:1;background-color:#E0E0E0;border-style:none none none none;" label="购物车" onClick="button20Click">
    <i xid="i27" class="e-commerce e-commerce-gouwuche"></i>
    <span xid="span15">购物车</span></a> </div></div> 
  </div>  
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
    ...
    <div class="x-popOver-content" xid="div41" style="width:100%;height:70%;"> 
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        ...
        <div class="x-panel-content" xid="content3"> 
          ...
          <img alt="" class="img-thumbnail tb-colorImg" bind-attr-src=' $model.dialogData.getCount()&gt;0?$model.dialogData.val("goods_img"):$model.goodsDataM.val("goods_img")'
            xid="image4"/>  
                ...
                <ul class="x-list-template" xid="listTemplateUl4" componentname="ul(html)"
                  ...
                  <li xid="li8" class="col col-xs-4" componentname="li(html)"
                    ...
                    <div class="text-center" bind-css="val(&quot;flag&quot;)==0?{'current2':color3Row.val('id')==$model.classValue3Data.val('id')}:{'current':color3Row.val('id')==$model.classValue3Data.val('id')}"
                      ...
                      <span bind-text="val(&quot;name&quot;)" xid="span99"/>
                    </div> 
                  </li> 
                </ul> 
              </div> 
              ...
              <div component="$UI/system/components/justep/row/row" class="x-row"
                ...
                <div class="x-col" xid="col19"> 
                  <div class="tb-numberOperation" xid="div30" style="text-align:right;"> 
                    ...
                    <span xid="span30" class="pull-right" style="line-height:0.8;height:30px;">1</span>  
                    <a component="$UI/system/components/justep/button/button"
