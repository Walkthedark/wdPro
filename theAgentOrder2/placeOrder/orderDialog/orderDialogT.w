...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <column name="dis_tag" type="String" xid="xid96"></column>
  <column name="specification" type="String" xid="xid97"></column></div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <rule xid="rule1">
   <col name="uuid" xid="ruleCol1">
    ...
    <calculate xid="calculate1">
     <expr xid="default8">justep.UUID.createUUID()</expr></calculate> </col> </rule>
  ...
  <column isCalculate="false" name="uuid" type="String" xid="xid94"></column></div></div>  
                  ...
                  <li xid="li1" class="media" bind-click="li1Click"> 
                    ...
                    <div class="media-body" xid="div14"> 
                      <h5 class="media-heading lead text-black" bind-text=" val(&quot;goods_name&quot;)"
                        xid="h51" style="color:#666;font-size:14px;"/>  
                      <div class="text-muted" xid="div21">
   <span xid="span44" class="text-danger tshowName" style="font-size:10px;border-style:solid solid solid solid;border-width:thin thin thin thin;border-color:#F7430C #F7430C #F7430C #F7430C;padding:1px 1px 1px 1px;" bind-text='val("dis_tag")' bind-visible='val("dis_tag") != ""'><![CDATA[]]></span></div><div class="text-muted" xid="div15"> 
                        <span xid="span11" class="text-danger" style="font-size:12px;">￥</span>  
                        <span xid="span9" bind-text=" val(&quot;price&quot;)" class="text-danger"
                          style="font-size:16px;"/> 
                      <span xid="span22" bind-text='"/"+val("unit_name")'><![CDATA[]]></span></div>  
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="popOver6" anchor="bottom6">
   ...
   <div class="x-popOver-content ddd" xid="div53" style="width:100%;height:60%;">
    <div xid="div54" style="height:100%;width:100%;background-color:white;">
     <div component="$UI/system/components/justep/panel/panel" class=" x-full x-panel " xid="panel6">
      <div class="x-panel-content" xid="content6">
       
       
       <div xid="div20" style="height:100%;width:100%;"><div xid="div35">
              <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"> 
                <div class="x-col x-col-20" xid="col4">
                  <img src=" " alt="" xid="image8" height="60px" style="width:60px;" class="img-rounded " />
                </div>  
            ...
            </div><div component="$UI/system/components/justep/list/list" class="x-list" xid="list3" data="GoodsInfodata"> 
                    ...
                    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1"> 
                      <div class="x-col x-col-67" xid="col2">
                        <h5 xid="h54"><![CDATA[]]>  
                          ...
                          <span xid="span28" bind-text="&quot;/&quot; + val(&quot;unit_name&quot;)" style="color:#666" />  
                        ...
                        <h5 xid="h55"><![CDATA[]]>
                          ...
                          <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-xs" label="button" xid="button2" style="background-color:#F9F8F9;color:#797979;margin-left:5px;" bind-text=" val(&quot;specification2_value&quot;)" bind-visible="val(&quot;specification2_name&quot;)!=&quot;&quot;"> 
                            <i xid="i10" />  
                            <span xid="span12" />
                          </a>  
                          <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-xs" label="button" xid="button3" style="background-color:#F9F8F9;color:#797979;margin-left:5px;" bind-text=" val(&quot;specification3_value&quot;)" bind-visible="val(&quot;specification3_name&quot;)!=&quot;&quot;" disabled="true"> 
                            <i xid="i21" />  
                            <span xid="span40" />
                          </a>
                        </h5>
                      ...
                      <div class="x-col" xid="col3">
                        <div class="tb-numberOperation" xid="div34" style="text-align:right;"> 
                          ...
                          <span xid="span32" class="pull-right" style="line-height:0.8;height:22px;" bind-text=" val(&quot;goods_num&quot;)==null?&quot;0&quot;: val(&quot;goods_num&quot;)"><![CDATA[]]></span>  
      ...
      <div class="x-panel-bottom" xid="bottom6">
       <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup3" style="background-color:#170153;color:#FFFEFF;"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="确定" xid="button7" style="color:#FFFEFF;" onClick="button7Click"> 
                <i xid="i12" />  
