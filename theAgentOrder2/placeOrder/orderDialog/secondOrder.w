...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
              ...
              <div component="$UI/system/components/justep/list/list" class="x-list tb-root"
                ...
                <ul class="x-list-template list-group" xid="listTemplateUl1"> 
                  <li xid="li1" class=" text-center tb-nopadding  list-group-item"
                    ...
                    <h5 xid="h52" bind-text=" val(&quot;cate_name&quot;)" class="text-black H5_span" style="font-family: “Microsoft YaHei” ! important;"><![CDATA[]]></h5></a></li> 
                </ul> 
              </div> 
            </div>  
   ...
   <span xid="span2">全部分类</span></a></div><div xid="div3"><div component="$UI/system/components/justep/list/list" class="x-list clearfix" xid="threeClassList" data="data3" dataItemAlias="threeClassRow">
   <ul class="x-list-template" xid="listTemplateUl4">
    <li xid="li4" class="col col-xs-4 text-center tb-listBox text-black" style="padding-left: 4px">
     <div xid="div1" bind-click="groupList">
      <img alt="" class="img-responsive" xid="image3" style=" min-width: 100%; height: 60px" src="$UI/theAgentOrder/img/menu13Pic2.jpg" bind-attr-src=' val("cate_img")'></img>
      <p bind-text=' val("cate_name")' xid="p3"></p></div> </li> </ul> 
  </div></div><div xid="div2"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="data1" disableInfiniteLoad="false" disablePullToRefresh="false"> 
                <ul class="x-list-template" xid="listTemplateUl2"> 
                  <li xid="li2"> 
                    <div class="panel-heading" xid="div26" bind-click="div7Click" style="width:100%;float:left;"> 
                      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-icon-right pull-right" xid="button21" icon="icon-ios7-arrow-right"> 
                    ...
                    <div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="data2" filter=" val(&quot;cate_id&quot;) == $row.val(&quot;parent_id&quot;)" disableInfiniteLoad="true" disablePullToRefresh="true"> 
                      <ul class="x-list-template" xid="listTemplateUl3"> 
                        <li xid="li3" class="col col-xs-4 text-center tb-listBox text-black" style="padding-left: 4px"> 
                          <div xid="div5" bind-click="groupList" style="height:100%;width:100%;"> 
                            <img alt="" class="img-responsive" xid="image1" style=" min-width: 100%; height: 60px" src="$UI/theAgentOrder/img/menu13Pic2.jpg" bind-attr-src=' val("cate_img")'/>  
