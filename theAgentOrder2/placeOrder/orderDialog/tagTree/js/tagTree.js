...
//		},
	...
	$.fn.tagTree = function(options){
	    ...
	    $(defaults.id+' li.li-top > span').on('click', function (e) {
	     ...
	     //  this.getElementsByTagName("i")[0].getAttribute('name')//获取id
	...
	function setTree(data,that)
	{
		...
		$.each(data,function(index,value){
			var li = $('<li><span>'+value.cate_name+'<i name='+value.cate_id+' data-val="'+value.cate_id+'" class="fa fa-check" style="display:none;">'+value.cate_id+'</i></span></li>');
			ul.append(li);
			if(value.child != null){
