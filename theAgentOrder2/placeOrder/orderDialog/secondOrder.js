define(function(require) {
	...
	Model.prototype.categoryDataCustomRefresh = function(event) {
		var params = {};
		params.clinet_id = this.params.data.clinet_id;
	...
	Model.prototype.groupList = function(event) {
		...
		justep.Shell.showPage("orderDialog", params);
	};
	// 二级分类点击事件
	...
	Model.prototype.ListloadGoodsOrderInfo = function(params) {
		...
		this.getParentModel().ListloadGoodsOrderInfo(params);
	...
	Model.prototype.setLocalStorne = function(params) {
		...
		localStorage.setItem("cartList", JSON.stringify(this.goodsDataInfo));
	};
	// 打开页面哦
