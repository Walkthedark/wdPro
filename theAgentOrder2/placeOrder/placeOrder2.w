...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <rule xid="rule2">
   <col name="Value" xid="ruleCol2">
    <calculate xid="calculate2">
     <expr xid="default5"><![CDATA[$model.goodsDataM.sum("fsum") +$model.data2.sum("fsum")]]></expr></calculate> </col> 
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data1" idColumn="id"><column name="id" type="String" xid="xid59"></column>
  <column name="name" type="Integer" xid="xid60"></column>
  <column name="Value" type="Double" xid="xid61"></column>
  <data xid="default12">[{&quot;id&quot;:&quot;1&quot;}]</data></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data3" onValueChanged="data1ValueChanged" idColumn="id">
   <column name="id" type="String" xid="column58"></column>
   <column name="col1" type="Date" xid="column57"></column>
   <data xid="default13">[{&quot;id&quot;:&quot;1&quot;}]</data></div></div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content6" style="background-color:#F1EFF5;"> 
     ...
     <ul class="x-list-template" xid="listTemplateUl1">
      <li xid="li1" bind-click="button14Click">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="添加赠品" xid="button22" style="border-style:solid solid solid solid;border-width:thin thin thin thin;border-color:#7B7B7B #7B7B7B #7B7B7B #7B7B7B;background-color:white;color:#7B7B7B" icon="glyphicon glyphicon-plus" onClick="button22Click">
    ...
    <span xid="span38">添加赠品</span></a></div></div><div xid="div28"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="goodsDataM">
  ...
  <span xid="span49" bind-text="  $model.data2.getCount()+$model.goodsDataM.getCount()"><![CDATA[0]]></span>
  ...
  <div xid="div15" style="padding:5px 10px 5px 10px;"><div class="media" xid="media4">
   ...
   <span xid="span20">不开发票</span></a></div> 
     ...
     <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input3" placeHolder="请输入" dataType="Float" format="0,000" bind-ref='$model.data1.ref("name")' onBlur="input3Blur"></input>
   ...
   <label class="x-label" xid="label5" style="width:7em;"><![CDATA[实收金额]]></label>
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input4" placeHolder="请输入" dataType="Float" bind-ref='$model.data1.ref("Value")' onBlur="input4Blur"></input>
   ...
   <span xid="span53">现金</span></a></div></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit18">
       ...
       <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input5" placeHolder="请选择" min="js:new Date()" dataType="Date" bind-ref='$model.data3.ref("col1")'></input></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit20">
       <label class="x-label" xid="label23" style="width:7em;">订单备注</label>
       <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control x-edit" xid="textarea4" placeHolder="请输入"></textarea></div>
  </div>
  </div>
  </div></div> 
  <div class="x-panel-bottom" xid="bottom1"><div component="$UI/system/components/justep/row/row" class="x-row tb-nopadding" xid="row2" style="padding-right:0px;;padding-top:0px;">
   ...
   <div class="x-col" xid="col4">
    ...
    <div class="text-right" xid="div11">
     ...
     <span xid="span1" bind-text="  $model.data2.getCount()+$model.goodsDataM.getCount()"><![CDATA[]]></span>
