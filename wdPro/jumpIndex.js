define(function(require) {
	...
	var Model = function() {
		...
		var shellImpl = new ShellImpl(this, {
			...
			"pageMappings" : {
				...
				"jumpMain" : {
					url : require.toUrl('./crmjump/jumpMain/jumpMain.w')
				},
				"contactPepInfoInfo" : {
				...
				"addLcientJump" : {
					url : require.toUrl('./crmjump/jumpClient/addLcientJump.w')
				},
				"pepInfo" : {
					url : require.toUrl('./crmjump/jumpClient/pepInfo.w')
				},
				"jumpaddClient" : {//业务经理
					url : require.toUrl('./crmjump/jumpClient/dialog/addClient.w')
				},
	...
	Model.prototype.modelParamsReceive = function(event) {
		...
		if (res.errcode == 0) {//
			...
			// justep.Shell.showPage("jumpMain");
			 this.comp("windowContainer1").load("$UI/wdPro/crmjump/jumpMain/jumpMain.w",{});
