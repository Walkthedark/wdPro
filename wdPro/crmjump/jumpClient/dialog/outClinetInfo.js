...
//		params.id = this.params.id;
	...
	Model.prototype.button5Click = function(event) {
		window.location.href ="./imageList.w?data="+this.listImage;
	};
	...
	Model.prototype.button35Click = function(event) {
		window.location.href ="./jumpAssociatedPop.w?id="+this.id;
	};
...
//			data : params
//		});
			window.location.href ="./jumpDetailedclientInfo.w?id="+this.id;
	};
	// 打电话
	...
	Model.prototype.button45Click = function(event){
		...
		window.location.href ="./jumpModifyConPep.w?id="+this.linkManId;
	};
	//增加跟单
...
//		});
		var id = documentaryData.getValue("documentary_id");
		window.location.href ="./jumpInfosalesOrder.w?id="+id;
	};
	//客户详情里面新增联系人
