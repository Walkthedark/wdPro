define(function(require) {
	...
	Model.prototype.setSavePostData = function(params) {
		//saveLinkman
		var res = asCore.setGetFalse(interFace.saveLinkman, params);
		if (res.code === 200) {
			justep.Util.hint("联系人新增成功");
			//打开新的页面
			window.location.href ="../jumpClient/pepInfo.w?id="+this.staff_id;
		}else{
	...
	Model.prototype.modelParamsReceive = function(event){
		this.staff_id =  this.getContext().getRequestParameter("id");;
	};
