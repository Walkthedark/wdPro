...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="business_Type_Data" idColumn="staff_id">
   <column name="staff_id" type="String" xid="column6"></column>
   <column name="staff_name" type="String" xid="column7"></column>
   <column name="phone" type="String" xid="column1"></column>
   <column name="is_checked" type="Integer" xid="column2"></column>
   <column name="head_img" type="String" xid="column3"></column>
   <column name="department_name" type="String" xid="column4"></column>
   <column name="custom_code" type="String" xid="column5"></column></div></div> 
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents2" wrap="false" swipe="false" slidable="false" routable="false">
   <div class="x-contents-content" xid="content7"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView2" onPullUp="scrollView2PullUp">
   <div class="x-scroll-content" xid="div4">
    <div xid="div10" class="list-group-item" style="padding:5px 5px 5px 5px;background-color:#EBEAF0;">
     <div class="media" xid="media2">
      <div class="media-body" xid="mediaBody2">
       <h5 xid="h53" style="color:#181919;"><![CDATA[抄送我的]]></h5></div> </div> </div> 
    <div component="$UI/system/components/justep/list/list" class="x-list" xid="list3" data="business_Type_Data">
         ...
         <div xid="div73" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;">
          <div class="media" xid="media2">
           <div class="media-left" xid="mediaLeft2">
            <a href="#" xid="a2">
             <img class="media-object" alt="" xid="image2" style="width:45px;height:45px;" bind-attr-src=' val("head_img")'></img></a> </div> 
           <div class="media-body" xid="mediaBody2">
            <h4 class="media-heading" xid="h42">
             <span xid="span18" style="color:#585958;" bind-text='val("staff_name")'>张三</span></h4> 
            <h5 xid="h53">
             <span xid="span11" bind-text='val("phone")' style="color:#585958;font-size:12px"></span></h5> </div> 
           <div class="media-right" xid="mediaRight9">
            </div> </div> </div> </div> </div> </li> </ul> </div> </div> 
   <div class="x-content-center x-pull-up" xid="div4">
    <span class="x-pull-up-label" xid="span20">加载更多...</span></div> </div></div><div class="x-contents-content" xid="content5"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1" onPullUp="scrollView1PullUp">
