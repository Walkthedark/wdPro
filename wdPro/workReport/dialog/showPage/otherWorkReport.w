...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="myreData" dataItemAlias="fatherList">
   ...
   <div class="media-left" xid="mediaLeft1">
    <a href="#" xid="a1">
     <img class="media-object " src="$UI/wdPro/common/img/head4.jpeg" alt="" xid="image1" style="width:57px;height:46px;" dir="imag"></img><h5 xid="h51" bind-text='val("create_staff")' style="text-align:center;font-size:16px;color:#2C2C2C;"><![CDATA[]]></h5></a> 
  </div> 
  ...
  <div xid="div5" class=" list-group-item" style="padding:0px 0px 0px 0px;text-align:right;">
   ...
   <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup2" style="background-color:white;">
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-only-icon" label="操作" xid="button7" icon="e-commerce e-commerce-jinru1">
     <i xid="i7" class="e-commerce e-commerce-jinru1" style="font-size:14px"></i>
