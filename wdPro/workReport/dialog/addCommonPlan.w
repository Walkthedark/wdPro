     ...
     <div xid="div32">
      <img alt="" class="img-responsive" xid="image3" style=";margin-top:5px;width:61px;height:61px;" bind-attr-src="val('url')"></img>
          ...
          <div xid="div6" class="list-group-item"> 
            <div xid="div5"> 
              <label xid="label4" class="x-label" style="font-weight:bold;"><![CDATA[开始时间]]></label> 
            </div>  
            <div xid="div4"> 
              <input component="$UI/system/components/justep/input/input" class="form-control"
                xid="input3" dataType="Date" style="border-style:none none none none;"/> 
            </div> 
          </div>  
          <div xid="div13" class="list-group-item"> 
            <div xid="div14"> 
              <label xid="label7" class="x-label" style="font-weight:bold;"><![CDATA[结束时间]]></label> 
            </div>  
            <div xid="div15"> 
              <input component="$UI/system/components/justep/input/input" class="form-control"
                xid="input4" dataType="Date" style="border-style:none none none none;"/> 
            </div> 
          </div>  
          <div xid="div24" style="height:10px;"/>
          <div xid="div27"> 
