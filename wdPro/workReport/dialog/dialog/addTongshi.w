...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:97px;left:39px;height:auto;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="client_Type_Data" idColumn="staff_id">
      <column name="staff_id" type="String" xid="xid1"></column>
  <column name="staff_name" type="String" xid="xid2"></column>
  <column name="choose" type="Integer" xid="xid3"></column>
  <column name="department_name" type="String" xid="xid4"></column>
  <column name="head_img" type="String" xid="xid5"></column></div>
  </div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <div class="media" xid="media1">
    <div class="media-body" xid="mediaBody1">
     <h5 xid="h51" style="color:#181919;">客户分类</h5></div> </div> </div><div component="$UI/system/components/justep/list/list" class="x-list"
        xid="list1" data="client_Type_Data"> 
   ...
   <a href="#" xid="a1">
    <img class="media-object" src="$UI/wdPro/common/img/head4.jpeg" alt="" xid="image1" style="height:40px;width:40px;"></img></a> </div><div class="media-body" xid="mediaBody9"> 
                  <h5 xid="h518" style="color:#181919;" bind-text=' val("staff_name")'>潜在用友客户</h5>
                <h5 xid="h52" style="color:#6D6D6D;font-size:12px;" bind-text=' val("department_name")'><![CDATA[]]></h5></div>  
