...
var __parent0=require('$model/UI2/wdPro/workReport/dialog/add'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cMj2YFf';
	this._flag_='5a2064ae1ea3e2ebc871a194862ef4d5';
	this._wCfg_={};
	this._appCfg_={};
