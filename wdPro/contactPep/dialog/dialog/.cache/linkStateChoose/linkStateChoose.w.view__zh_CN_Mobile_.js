...
var __parent0=require('$model/UI2/wdPro/contactPep/dialog/dialog/linkStateChoose'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='c7BF3Ub';
	this._flag_='bf20fbd5df8ffd599bbaf5bc37c22eca';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"choose":{"define":"choose","name":"choose","relation":"choose","rules":{"integer":true},"type":"Integer"},"id":{"define":"id","name":"id","relation":"id","type":"String"},"name":{"define":"name","name":"name","relation":"name","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","initData":"[{\"id\":\"0\",\"name\":\"未关注\",\"choose\":{\"value\":\"\"}},{\"id\":\"1\",\"name\":\"已关注\"}]","isMain":false,"limit":20,"xid":"sexData"});
}}); 
return __result;});
