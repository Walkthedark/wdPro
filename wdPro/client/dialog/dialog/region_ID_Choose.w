  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <div class="media" xid="media1">
    <div class="media-body" xid="mediaBody1">
     <h5 xid="h51" style="color:#181919;"><![CDATA[销售区域]]></h5></div> 
            ...
            <div xid="div22" class="list-group-item" style="padding:5px 5px 5px 5px;"> 
              <div class="media" xid="media9"> 
                ...
                <div class="media-right" xid="mediaRight8"> 
                  <span component="$UI/system/components/justep/button/radio" class="x-radio" xid="radio1" checked="true" name="chooseName" onChange="radio1Change" bind-ref='ref("choose")' checkedValue="1" uncheckedValue="0"></span></div> 
              </div> 
            </div>
          </li>
        </ul> 
