...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column name="level_name" type="String" xid="xid2"></column></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dataJson" idColumn="id" confirmRefresh="false">
   ...
   <column name="client_name" type="String" xid="column2"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="button1" style="color:#838484;" onClick="button1Click">
    <i class="icon-chevron-right" xid="i1"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link" icon="icon-chevron-right" xid="region1" style="color:#838484;" onClick="region_ID_btnClick" label="dasd">
    <i class="icon-chevron-right" xid="i3"></i></a> 
  </span></div> 
                </div> 
              </div> 
            </div>  
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="business1" style="color:#838484;" onClick="business_type_btnClick">
    <i class="icon-chevron-right" xid="i5"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="level1" style="color:#838484;" onClick="level_id_btnClick">
    <i class="icon-chevron-right" xid="i4"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
            <div xid="div82" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;">
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit15">
    <label class="x-label" style="width:90px;font-size:16px" xid="label15">业务经理</label>
    <div class="x-edit" xid="div76">
     <div class="input-group" xid="div79">
      <input component="$UI/system/components/justep/input/input" class="form-control" xid="input2" style="background-color:white;border-style:none none none none;" disabled="true"></input>
      <span class="input-group-btn" xid="span29">
       <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="button3" style="color:#838484;" onClick="button3Click">
        <i class="icon-chevron-right" xid="i14"></i></a> </span> </div> </div> </div> </div><div xid="div37" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="source3" style="color:#838484;" onClick="source_BtnClick">
    <i class="icon-chevron-right" xid="i6"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="establish1" style="color:#838484;" onClick="establish_Time_BtnClick">
    <i class="icon-chevron-right" xid="i7"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div49"> 
                  <div class="input-group" xid="div44"> 
                    ...
                    <span class="input-group-btn" xid="span16">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="service1" style="color:#838484;" onClick="service_Rate_BtnClick">
    <i class="icon-chevron-right" xid="i8"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div40"> 
                  <div class="input-group" xid="div41"> 
                    ...
                    <span class="input-group-btn" xid="span17">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="deal1" style="color:#838484;" onClick="deal_Impression_BtnClick">
    <i class="icon-chevron-right" xid="i9"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
            <div xid="div4" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="bank_Name_Inp" bind-ref='$model.dataJson.ref("bank_name")'/> 
              </div> 
            </div>  
            <div xid="div5" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="bank_Inp" bind-ref='$model.dataJson.ref("bank")'/> 
              </div> 
            </div>  
            ...
            <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit16"> 
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="bank_Account_Inp" bind-ref='$model.dataJson.ref("bank_account")' /> 
              </div></div><div xid="div8" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                class="x-label-edit x-label30" xid="labelEdit4"> 
                <label class="x-label" xid="label4" style="width:90px;font-size:16px"><![CDATA[税号]]></label>  
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="tax_Num_Inp" bind-ref='$model.dataJson.ref("tax_num")'/> 
              </div> 
            </div>  
            <div xid="div7" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="remark_Inp" bind-ref='$model.dataJson.ref("remark")'/> 
              </div> 
            </div>  
            ...
            </div><div xid="div11" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <div xid="div18" class="list-group-item" style="display:none;;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="main_Product_Inp" bind-ref='$model.clientData.ref("main_product")'/> 
              </div> 
            </div>  
              
            <div xid="div43" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div39"> 
                  <div class="input-group" xid="div42"> 
                    ...
                    <span class="input-group-btn" xid="span18">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="trade1" style="color:#838484;" onClick="trade_Id_BtnClick">
    <i class="icon-chevron-right" xid="i10"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div60"> 
                  <div class="input-group" xid="div58"> 
                    ...
                    <span class="input-group-btn" xid="span23">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="enterprise1" style="color:#838484;" onClick="enterprise_Nature_BtnClick">
    <i class="icon-chevron-right" xid="i11"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div61"> 
                  <div class="input-group" xid="div56"> 
                    ...
                    <span class="input-group-btn" xid="span24">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="year1" style="color:#838484;" onClick="year_Turnover_BtnClick">
    <i class="icon-chevron-right" xid="i12"></i></a> </span></div> 
                </div> 
              </div> 
            </div>  
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="x-edit" xid="div52"> 
                  <div class="input-group" xid="div53"> 
                    ...
                    <span class="input-group-btn" xid="span25">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="enterprise2" style="color:#838484;" onClick="enterprise_Scale_BtnClick">
    <i class="icon-chevron-right" xid="i13"></i></a> </span></div> 
                </div> 
              </div> 
            </div> 
          </div>  
