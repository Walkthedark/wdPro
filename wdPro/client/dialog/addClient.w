...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:2px;left:59px;" onLoad="modelLoad"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dataJson" idColumn="id" confirmRefresh="false"><column name="id" type="String" xid="xid1"></column>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="恋爱经历" xid="button11" target="content5">
      ...
      <div xid="div2" class="list-group-item" style="border-right-style:none;border-left-style:none;padding-right:0px;padding-top:2px;padding-bottom:2px;">
        <div xid="div3" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;">
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit1"> 
            <label class="x-label" xid="label1" style="width:90px;font-size:16px"><![CDATA[客户名称]]><span xid="span18" style="color:#FD3240;">*</span></label>  
   ...
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit14">
    <label class="x-label" style="width:90px;font-size:16px" xid="label14"><![CDATA[客户编码]]><span xid="span23" style="color:#FD3240;">*</span></label>
   ...
   <i xid="i16"></i>
   <span xid="span17">生成</span></a></span> </div> </div> </div> 
  </div><div xid="div20" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit19"> 
            <label class="x-label" style="width:90px;font-size:16px" xid="label19"><![CDATA[客户分类]]><span xid="span24" style="color:#FD3240;">*</span></label>  
        ...
        <div xid="div28" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit21"> 
            <label class="x-label" style="width:90px;font-size:16px" xid="label21"><![CDATA[销售区域]]><span xid="span25" style="color:#FD3240;">*</span></label>  
        ...
        <div xid="div34" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit23"> 
            <label class="x-label" style="width:90px;font-size:16px" xid="label23"><![CDATA[业务模式]]><span xid="span27" style="color:#FD3240;">*</span></label>  
        ...
        <div xid="div31" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit22"> 
            <label class="x-label" style="width:90px;font-size:16px" xid="label22">客户等级<span xid="span28" style="color:#FD3240;">*</span></label>  
   ...
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit15">
    <label class="x-label" style="width:90px;font-size:16px" xid="label15"><![CDATA[业务经理
     ]]></label> 
    <div class="x-edit" xid="div76">
     <div class="input-group" xid="div79">
      <input component="$UI/system/components/justep/input/input" class="form-control" xid="input2" placeHolder="请选择" style="background-color:white;border-style:none none none none;" disabled="true"></input>
      <span class="input-group-btn" xid="span29">
       <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" icon="icon-chevron-right" xid="button3" style="color:#838484;" onClick="button3Click">
        ...
        <div xid="div47" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
      ...
      <div xid="div62" class="list-group-item" style="text-align:center;" bind-click="div62Click">
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="新建联系人" xid="button15" style="color:#838484;font-size:16px" icon="icon-plus-round"> 
          <i xid="i15" class="icon-plus-round" />  
          <span xid="span16">新建联系人</span>
        </a>
      </div>  
      <div xid="div15" class="list-group-item" style="display:none;text-align:right;border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;" bind-click="div62Click">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="删除联系人" xid="button2" style="color:#838484;" icon="linear linear-trash">
    <i xid="i2" class="linear linear-trash"></i>
    <span xid="span3">删除联系人</span></a> </div><div xid="div63" class="list-group-item" style="display:none;border-right-style:none;border-left-style:none;padding-right:0px;padding-top:2px;padding-bottom:2px;">
        <div xid="div64" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit29"> 
            <label class="x-label" xid="label30" style="width:80px;"><![CDATA[姓名]]></label>  
            <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="staff_Name_Inp" />
          </div> 
        </div>  
        <div xid="div65" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit33"> 
            <label class="x-label" xid="label33" style="width:80px;"><![CDATA[手机]]></label>  
            <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="linkman_Phone_Inp" />
          </div> 
        </div>  
        <div xid="div66" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit34"> 
            <label class="x-label" xid="label34" style="width:80px;"><![CDATA[职务]]></label>  
            <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="linkMan_Duty_Inp" />
          </div> 
        </div>  
        <div xid="div67" class="list-group-item" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit35"> 
            <label class="x-label" xid="label35" style="width:80px;"><![CDATA[爱好]]></label>  
            <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="hobby_Inp" />
          </div> 
        </div>
      </div>  
  ...
  <div xid="div102" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;">
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit81">
    ...
    <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input40" dataType="Date"></input></div> </div>
  <div xid="div106" style="border-right-style:none;border-left-style:none;padding:5px 5px 5px 5px;">
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit82">
    ...
    <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input42" dataType="Date"></input></div> </div>
