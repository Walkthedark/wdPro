  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        ...
        <div class="x-titlebar-title" xid="title2">龙虎榜</div>  
            ...
            <div component="$UI/system/components/justep/row/row" class="x-row"
              ...
              <div class="x-col" xid="col4"> 
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row3" style="display:none" id="ListRow1"> 
                  ...
                  <div class="col col-xs-12 border-Two" xid="col21"> 
                    <div class="progress" component="$UI/system/components/bootstrap/progress/progress"
                      ...
                      <div class="progress-bar progress-bar-success" role="progressbar"
                        xid="progressBar2"> 
                        <span xid="span16" id="Num1"><![CDATA[次]]></span> 
                      </div> 
                    </div> 
                  </div>  
                  <div class="col col-xs-12 mar2" xid="col23" style="text-align:center;"
                    bind-click="col53Click"> 
          ...
          <div xid="div7" class="mar2 border-div" style="background-color:white;"> 
            ...
            <div component="$UI/system/components/justep/row/row" class="x-row"
              ...
              <div class="x-col" xid="col47"> 
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row24" id="ListRow3"> 
                  <div class="col col-xs-12" xid="col46"> 
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      xid="row23"> 
                      <div class="x-col" xid="col52"> 
                        <span xid="span27" id="Name2"><![CDATA[李四：]]></span> 
                      </div>  
                  ...
                  <div class="col col-xs-12 border-Two" xid="col44"> 
                    <div class="progress" component="$UI/system/components/bootstrap/progress/progress"
                      ...
                      <div class="progress-bar progress-bar-success" role="progressbar"
                        xid="progressBar4"> 
                        <span xid="span26" bind-text="&quot;2次&quot;" id="Num2"><![CDATA[2次]]></span> 
                      </div> 
                    </div> 
                  </div>  
                  <div class="col col-xs-12 mar2" xid="col53" style="text-align:center;"
                    bind-click="col53Click"> 
                    <span xid="span2" class="font-six"><![CDATA[点击查看更多]]></span> 
                  </div> 
                </div>  
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row17" style="display:none" id="ListRow4"> 
                ...
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  ...
                  <div class="col col-xs-12 border-Two" xid="col29"> 
                    <div class="progress" component="$UI/system/components/bootstrap/progress/progress"
                      ...
                      <div class="progress-bar progress-bar-success" role="progressbar"
                        xid="progressBar3"> 
                        <span xid="span20" bind-text="&quot;2次&quot;" id="Num3">2次</span> 
                      </div> 
                    </div> 
                  </div>  
                  <div class="col col-xs-12 mar2" xid="col31" style="text-align:center;"
                    bind-click="col53Click"> 
                    <span xid="span18" class="font-six">点击查看更多</span> 
                  </div> 
                </div>  
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row10" style="display:none" id="ListRow6"> 
          ...
          <div xid="div2" class="mar2 border-div" style="background-color:white;"> 
            ...
            <div component="$UI/system/components/justep/row/row" class="x-row"
              ...
              <div class="x-col" xid="col5"> 
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row8" id="ListRow7"> 
                  <div class="col col-xs-12" xid="col6"> 
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      xid="row6"> 
                      <div class="x-col" xid="col12"> 
                        <span xid="span7" id="Name4"><![CDATA[陕西银泽贸易有限公司：]]></span> 
                      </div>  
                  ...
                  <div class="col col-xs-12 border-Two" xid="col8"> 
                    <div class="progress" component="$UI/system/components/bootstrap/progress/progress"
                      ...
                      <div class="progress-bar progress-bar-success" role="progressbar"
                        xid="progressBar1"> 
                        <span xid="span8" bind-text="&quot;2.12万元&quot;" id="Num4"><![CDATA[2.12万元]]></span> 
                      </div> 
                    </div> 
                  </div>  
                  <div class="col col-xs-12 mar2" xid="col10" style="text-align:center;"
                    bind-click="col10Click"> 
                    <span xid="span9" class="font-six">点击查看更多</span> 
                  </div> 
                </div>  
                <div component="$UI/system/components/bootstrap/row/row" class="row"
                  xid="row25" style="display:none" id="ListRow8"> 
