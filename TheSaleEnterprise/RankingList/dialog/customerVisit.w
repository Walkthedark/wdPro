...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="data2" idColumn="bfr"> 
      <column name="cs" type="String" xid="xid3"/>  
      <column name="bfr" type="String" xid="xid4"/>  
      <column name="money" type="String" xid="xid9"/>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        ...
        <div class="x-titlebar-title" xid="title2">客户拜访龙虎榜</div>  
                          ...
                          <div class="col col-xs-6" xid="col4"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              ...
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit" xid="output1" bind-ref="ref(&quot;bfr&quot;)"/> 
                            </div> 
                          </div>  
                          <div class="col col-xs-6" xid="col5"> 
                            <div component="$UI/system/components/justep/output/output"
                              class="x-output" xid="output2" bind-ref="val(&quot;cs&quot;)+&quot;次&quot;"
                              style="text-align:right;"/> 
                          </div>  
                          <div class="col col-xs-12" xid="col6" style="text-align:right;"> 
                            <img src="$UI/TheSaleEnterprise/RankingList/img/005.png"
                              alt="" xid="image1" style="width:30px;"/> 
                          </div> 
                        </div> 
                      </div> 
                    </div> 
