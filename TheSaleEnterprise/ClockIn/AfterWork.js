define(function(require) {
	...
	Model.prototype.compress = function(res) {
		...
		img.onload = function() {
			...
			var Insert = document.getElementById("afterWorkImg1");
			var div6 = document.getElementById("afterWorkImg");
	...
	// 拍照
	Model.prototype.AImageClick = function(event) {
		this.picSource(50, 1);
	};
	...
	Model.prototype.button4Click = function(event) {
		// 3. 下班打卡 地址：http://61.129.51.183:9986/index/mobile/xbdk
		var CData = this.comp("CData");
		var sendUrl = "/index/mobile/xbdk";
		var xbdd = address;
		var xbzp = CData.getValue("tp");
		var xbsm = CData.getValue("sm");
		asCore.sendPostAfterWork(sendUrl, xbdd, xbzp, xbsm, function(e) {
			if (e.success == 1) {
				justep.Util.hint("打卡成功！");
			} else {
				justep.Util.hint("打卡失败！");
			}
		});
	};
	return Model;
