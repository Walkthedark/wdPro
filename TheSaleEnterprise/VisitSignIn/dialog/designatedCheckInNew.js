define(function(require) {
	...
	Model.prototype.getTypeList = function() {
		...
		var sendUrl = "/index/mobile/qdhblx";
		var data = {};
		asCore.qdhblx(sendUrl, data, function(data) {
			CData.loadData(data);
		});
	}
	...
	Model.prototype.init = function() {
		$("#DesignatedCheckInImg1").show();
		this.eventBind();
	};
	Model.prototype.eventBind = function() {
		var that = this;
		$("#uploadDesignatedCheckIn").click();
		$("#uploadDesignatedCheckIn").unbind().change(function() {
	...
	Model.prototype.compress = function(res) {
		...
		if (length < 6) {
			...
			img.onload = function() {
				...
				var Insert = document.getElementById("DesignatedCheckInImg1");
				var div6 = document.getElementById("DesignatedCheckInImg");
	...
	Model.prototype.button4Click = function(event) {
		...
		var self = this;
		var sendUrl = "/index/mobile/addqdhb";
		var qdzp = "";
		...
		data.qdms = qdms;
		data.qdzp = qdzp;
		asCore.addqdhb(sendUrl, data, function(data) {
			if (data.success == 1) {
