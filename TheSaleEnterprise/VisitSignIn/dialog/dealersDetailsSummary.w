    ...
    <div class="x-panel-content" xid="content6"> 
      <div component="$UI/system/components/justep/row/row" class="x-row border-One mar2"
        ...
        <div class="x-col" xid="col1" style="text-align:center;"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label1"><![CDATA[拜访小结：]]></label>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"> 
        <div class="x-col" xid="col4">
          <div class="imgline" xid="div74" id="DealersSummaryImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="DealersSummaryImg1">+
              <input id="uploadDealersSummary" type="file" class="upfile" accept="image/*,video/*;"
