define(function(require) {
	...
	Model.prototype.init = function() {
		$("#DealersSignInImg1").show();
		this.eventBind();
	};
	Model.prototype.eventBind = function() {
		var that = this;
		$("#uploadDealersSignIn").click();
		$("#uploadDealersSignIn").unbind().change(function() {
	...
	Model.prototype.compress = function(res) {
		...
		if (length < 6) {
			...
			img.onload = function() {
				...
				var Insert = document.getElementById("DealersSignInImg1");
				var div6 = document.getElementById("DealersSignInImg");
	...
	Model.prototype.button4Click = function(event) {
		var self = this;
		var sendUrl = "/index/mobile/bfqd";
		var qddz = address;
		var qdzp = "";
		if (asCore.isNull(this.UrlData)) {
			qdzp = this.UrlData;
		}
		asCore.sendPostJXSQD(sendUrl, jxs_id, qddz, qdzp, function(data) {
			if (data.success == 1) {
