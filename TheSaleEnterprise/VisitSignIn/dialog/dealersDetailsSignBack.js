define(function(require) {
	...
	Model.prototype.init = function() {
		$("#DealersSignBackImg1").show();
		this.eventBind();
	};
	Model.prototype.eventBind = function() {
		var that = this;
		$("#uploadDealersSignBack").click();
		$("#uploadDealersSignBack").unbind().change(function() {
	...
	Model.prototype.compress = function(res) {
		...
		if (length < 6) {
			...
			img.onload = function() {
				...
				var Insert = document.getElementById("DealersSignBackImg1");
				var div6 = document.getElementById("DealersSignBackImg");
	...
	Model.prototype.button4Click = function(event) {
		var self = this;
		var sendUrl = "/index/mobile/pfqt";
		var qtdz = address;
		var qtzp = "";
		if (asCore.isNull(this.UrlData)) {
			qtzp = this.UrlData;
		}
		// 16、经销商拜访签退 地址：http://61.129.51.183:9986/index/mobile/xcbfjh
		asCore.sendPostJXSBFQT(sendUrl, jxs_id, qtdz, qtzp, function(data) {
			debugger
			if (data.success == 1) {
