define(function(require) {
	...
	Model.prototype.init = function() {
		$("#DealersSummaryImg1").show();
		this.eventBind();
	};
	Model.prototype.eventBind = function() {
		var that = this;
		$("#uploadDealersSummary").click();
		$("#uploadDealersSummary").unbind().change(function() {
	...
	Model.prototype.compress = function(res) {
		...
		if (length < 6) {
			...
			img.onload = function() {
				...
				var Insert = document.getElementById("DealersSummaryImg1");
				var div6 = document.getElementById("DealersSummaryImg");
	...
	Model.prototype.button4Click = function(event) {
		var self = this;
		var bcbfxj = this.comp("textarea1").val();
		var sendUrl = "/index/mobile/bfxj";
		var bcbfxjzp = "";// 拜访小结照片
		if (asCore.isNull(this.UrlData)) {
			bcbfxjzp = this.UrlData;
		}
		asCore.sendPostBFXJ(sendUrl, jxs_id, bcbfxj, bcbfxjzp, function(data) {
			if (data.success == 1) {
