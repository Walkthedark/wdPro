...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="dailyCostData" idColumn="id"> 
      <column name="id" type="String" xid="xid1"></column>
  <column name="cuser" type="String" xid="xid2"></column>
  <column name="no" type="String" xid="xid3"></column>
  <column name="pizhunjin" type="String" xid="xid4"></column>
  <column name="state" type="String" xid="xid5"></column>
  <column name="ctime" type="String" xid="xid6"></column>
  <column name="title" type="String" xid="xid7"></column>
  <column name="statetype" type="String" xid="xid8"></column></div> 
  </div>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="newDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/dailyCostNew.w" forceRefreshOnOpen="true" onClose="newDialogClose"/>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="infoDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/dailyCostInfo.w" forceRefreshOnOpen="true"/>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel3"> 
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        xid="titleBar2" title="日常费用报销"> 
        ...
        <div class="x-titlebar-title" xid="title2">日常费用报销</div>  
                      ...
                      <div class="x-col" xid="col1"> 
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-6 border-Two font-style" xid="col9"
                            ...
                            <div component="$UI/system/components/justep/output/output"
                              class="x-output x-edit  font-style" xid="output3" bind-ref="ref(&quot;pizhunjin&quot;)"
                              style="float:right;margin-top:-8px;"/>  
                            <label class="x-label" xid="label3" style="float:right;"><![CDATA[总额：]]></label> 
                          </div>  
