...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input1" bind-ref='"金六福经销部"'></input></div><div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <textarea component="$UI/system/components/justep/textarea/textarea"
                  class="form-control x-edit" xid="textarea2"/> 
              </div>  
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3"
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-only-label"
          label="提 交" xid="button2" style="width:100%;" onClick="button2Click"> 
          <i xid="i2"/>  
