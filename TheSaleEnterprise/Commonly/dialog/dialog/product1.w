...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column name="pro_name" type="String" xid="xid4"></column>
  <column name="unit" type="String" xid="xid1"></column>
  <column name="pro_no" type="String" xid="xid2"></column>
  <column name="lingshou_price" type="String" xid="xid5"></column></div>
  </div>  
