...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="businessTripData" idColumn="id"> 
      <data xid="default1">[{"id":"1","col1":"出差测试申请","col2":"2018021600001","col3":"0天1小时","col4":"已归档","col5":"2018-02-16 11:44"}]</data>  
      <column name="id" type="String" xid="xid1"/>  
      <column name="sn" type="String" xid="xid2"/>  
      <column name="state" type="String" xid="xid3"/>  
      <column name="title" type="String" xid="xid4"/>  
      <column name="ctime" type="String" xid="xid5"/> 
    </div> 
  </div>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="newDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/businessTripNew.w" forceRefreshOnOpen="true"/>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="infoDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/businessTripInfo.w" forceRefreshOnOpen="true"/>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel3"> 
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        xid="titleBar2" title="出差申请"> 
        ...
        <div class="x-titlebar-title" xid="title2">出差申请</div>  
          ...
          <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
            ...
            <div class="x-scroll-content" xid="div2"> 
              <div component="$UI/system/components/justep/list/list" class="x-list"
                xid="list1" data="businessTripData"> 
                <ul class="x-list-template" xid="listTemplateUl1"> 
                  <li xid="li1" class="mar2"> 
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      xid="row1"> 
                      <div class="x-col" xid="col1"> 
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row4" bind-click="li1Click"> 
                          <div class="col col-xs-12" xid="col7"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              ...
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit font-One" xid="output1" bind-ref="ref(&quot;sn&quot;)"/> 
                            </div> 
                          </div>  
   ...
   <div class="col col-xs-12" xid="col17" style="text-align:right;padding:0px;"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group" tabbed="true" xid="buttonGroup1">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="删除" xid="button3" icon="linear linear-cross" style="color:#000000;" onClick="button3Click" bind-visible=" val(&quot;state&quot;)=='草稿'">
    <i xid="i4" class="linear linear-cross"></i>
