...
var __parent0=require('$model/UI2/TheSaleEnterprise/login/login'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cy2Ib6j';
	this._flag_='f35f8a98dff0e2b4840a28de8a73c882';
	this._wCfg_={};
	this._appCfg_={};
