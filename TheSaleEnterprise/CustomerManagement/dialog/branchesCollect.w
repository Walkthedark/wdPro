    ...
    <div class="x-panel-content" xid="content6"> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row border-One mar2"
        ...
        <div class="x-col" xid="col7"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label2" style="width:80px;"><![CDATA[定位地址：]]></label>  
            <div class="x-edit" xid="div2">
              <a component="$UI/system/components/justep/button/button" class="btn btn-default2"
                label="刷新定位" xid="button9" onClick="map"> 
                <i xid="i8"/>  
                <img src="$UI/TheSaleEnterprise/ClockIn/img/002.png" xid="image2"
                  style="width:15px;"/>  
                <span xid="span9">刷新定位</span>
              </a>
              <a component="$UI/system/components/justep/button/button" class="btn btn-default2"
                label="复制为经销商地址" xid="button8" style="margin-left:10px;"> 
                <i xid="i9"/>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row border-One"
        ...
        <div class="x-col" xid="col8"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label1" style="width:80px;"><![CDATA[网点地址：]]></label>  
            <textarea component="$UI/system/components/justep/textarea/textarea"
              class="form-control x-edit" xid="branchesAddress"/> 
          </div> 
        </div> 
      </div>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"> 
        <div class="x-col" xid="col4">
          <div class="imgline" xid="div74" id="netCollectImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="netCollectImg1">+
              <input id="upload3" type="file" class="upfile" accept="image/*,video/*;"
