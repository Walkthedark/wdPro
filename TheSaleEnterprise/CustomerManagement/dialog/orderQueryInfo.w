...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="spData" idColumn="id" limit="-1"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="detailList" idColumn="id"> 
      <column name="id" type="String" xid="column3"/>  
      <column name="category" type="String" xid="column8"/>  
      <column name="prod_name" type="String" xid="column9"/>  
      <column name="num" type="String" xid="column10"/>  
      <column name="dzsl" type="String" xid="column7"/>  
      <column name="ysje" type="String" xid="xid9"/> 
    </div> 
  </div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content6"> 
      <div component="$UI/system/components/bootstrap/row/row" class="row row-padding border-Two"
        xid="row1" style="padding:0px;margin:0px;"> 
        <div class="col col-xs-12 col-padding" xid="col1" style="padding:0px;"> 
          <div component="$UI/system/components/justep/row/row" class="x-row col-padding"
            xid="row2"> 
            <div class="x-col x-col-20" xid="col7" style="margin:auto;text-align:center;"> 
              <img src="$UI/TheSaleEnterprise/Commonly/img/006.png" alt="" xid="image1" class="wh" bind-attr-src=" "/> 
            </div>  
            <div class="x-col" xid="col8"> 
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                xid="row3" style="margin:0px;"> 
                <div class="col col-xs-12" xid="col10"> 
                  <div component="$UI/system/components/justep/output/output"
                    class="x-output font-One" xid="output1" bind-ref="&quot;（&quot;+$model.CData.val(&quot;bm&quot;) + &quot;）的销售订单申请&quot;"/> 
                </div>  
                <div class="col col-xs-12" xid="col11"> 
                  <div component="$UI/system/components/justep/output/output"
                    class="x-output font-Three" xid="output5" bind-ref="$model.CData.val(&quot;sqr&quot;) + &quot;(&quot;+$model.CData.val(&quot;zw&quot;)+&quot;)&quot;"/> 
                </div> 
              </div> 
            </div> 
          </div> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5"> 
        <div class="x-col" xid="col9"> 
          <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
            altRows="true" class="x-grid-no-bordered" xid="grid1" data="detailList"
            ...
            <columns xid="columns1"> 
              <column width="50" name="category" xid="column6" label="类型" align="center"/>  
              <column width="100" name="prod_name" xid="column1" label="产品名称"
                align="center"/>  
              <column width="60" name="num" xid="column2" label="订货数量" align="center"/>  
              <column width="60" name="dzsl" xid="column4" label="搭赠数量" align="center"/>  
              <column width="100" name="ysje" xid="column5" label="金额" align="center"/> 
            </columns>  
          ...
          <ul class="x-list-template" xid="listTemplateUl1"> 
            <li xid="li1"> 
              <div component="$UI/system/components/bootstrap/row/row" class="row row-padding"
                xid="row4" style="padding:0px;margin:0px;"> 
