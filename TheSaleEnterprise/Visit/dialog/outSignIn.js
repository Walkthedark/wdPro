define(function(require) {
	...
	Model.prototype.eventBind = function() {
		var that = this;
		$("#uploadOutSignIn").click();
		$("#uploadOutSignIn").unbind().change(function() {
	...
	Model.prototype.compress = function(res) {
		...
		if (length < 6) {
			...
			img.onload = function() {
				...
				var Insert = document.getElementById("OutSignInImg1");
				var div6 = document.getElementById("OutSignInImg");
	...
	Model.prototype.button4Click = function(event) {
		var sendUrl = "/index/mobile/wdbfqd";
		var qdzp = "";
		...
		asCore.sendWdbfqd(sendUrl, wdid, qddz, qdzp, function(data) {
			if (data.success == 1) {
