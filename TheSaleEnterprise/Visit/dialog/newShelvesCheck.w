...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:655px;left:162px;height:auto;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="cData" idColumn="cp_id" autoNew="true"> 
      <column name="cp_id" type="String" xid="xid1"/>  
      <column name="cllx" type="String" xid="xid2"/>  
      <column name="cllxName" type="String" xid="xid3"/>  
      <column name="cp_name" type="String" xid="xid4"/>  
    ...
    <div class="x-panel-content" xid="content6"> 
            ...
            <div class="col col-xs-12" xid="col18"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="input1" bind-ref="$model.cData.ref(&quot;cp_name&quot;)"/>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"
        ...
        <div class="x-col" xid="col4"> 
          <div class="imgline" xid="div74" id="ShelvesCheckImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="ShelvesCheckImg1">+
              <input id="uploadShelvesCheck" type="file" class="upfile" accept="image/*,video/*;"
