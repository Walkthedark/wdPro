        ...
        <div component="$UI/system/components/bootstrap/row/row" class="row"
          ...
          <div class="col col-xs-12" xid="col18"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                xid="input4" readonly="true" bind-ref="$model.orderData.ref(&quot;pro_name&quot;)"/> 
            </div> 
          </div>  
          <div class="col col-xs-12" xid="col21"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                xid="input2" style="width:30px;" bind-ref="$model.orderData.ref(&quot;ghj&quot;)"/>  
              <div component="$UI/system/components/justep/output/output" class="x-output"
                xid="output5" bind-ref='$model.orderData.ref("unit")'/> 
            </div> 
          </div>  
          <div class="col col-xs-12" xid="col1"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                xid="input3" style="width:30px;" bind-ref="$model.orderData.ref(&quot;xiang&quot;)"/>  
              <label class="x-label" xid="label5" style="width:1em;"><![CDATA[箱]]></label>  
              <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                xid="input5" bind-ref="$model.orderData.ref(&quot;ge&quot;)"/>  
          ...
          <div class="col col-xs-12" xid="col4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <textarea component="$UI/system/components/justep/textarea/textarea"
                class="form-control x-edit" xid="textarea1" bind-ref="$model.orderData.ref(&quot;cpbz&quot;)"/> 
            </div> 
          </div> 
        </div>
      </div>  
