  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        ...
        <div class="x-titlebar-title" xid="title2">修改竞品</div>  
    ...
    <div class="x-panel-content" xid="content6" style="background-color:#f0f0f0;"> 
            ...
            <div class="col col-xs-12" xid="col15"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <select component="$UI/system/components/justep/select/select"
                  ...
                  onChange="select1Change" disabled="true"/> 
              </div> 
            </div>  
            <div class="col col-xs-12" xid="col16"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <select component="$UI/system/components/justep/select/select"
                  ...
                  bind-options="googdList" bind-optionsValue="id" bind-optionsLabel="c_name" onChange="select2Change" disabled="true"/> 
              </div> 
            </div>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3"
        ...
        <div class="x-col" xid="col5"> 
          <div class="imgline" xid="div74" id="editComGoodsImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="editComGoodsImg1">+
              <input id="uploadeditComGoods" type="file" class="upfile" accept="image/*,video/*;"
