    ...
    <div class="x-panel-content" xid="content6"> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"
        ...
        <div class="x-col" xid="col4"> 
          <div class="imgline" xid="div74" id="editInventoryCheckImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="editInventoryCheckImg1">+
              <input id="uploadeditInventoryCheck" type="file" class="upfile"
