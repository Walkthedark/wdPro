...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="workData" idColumn="em_id"> 
      <column name="em_id" type="String" xid="xid2"/>  
      <column name="em_bm" type="String" xid="xid3"/>  
      <column name="rq" type="String" xid="xid4"/>  
      <column name="nr" type="String" xid="xid6"/>  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="newDialog"
    src="$UI/TheSaleEnterprise/WorkReport/dialog/workReportNew.w" forceRefreshOnOpen="true"/>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top3" height="110"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        ...
        <div class="x-titlebar-title" xid="title2">下属工作日报</div>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row border-Two"
        ...
        <div class="x-col" xid="col5"> 
          <input component="$UI/system/components/justep/input/input" class="font-Three form-control"
            xid="input2" placeHolder="可按部门，报告人，报告日期筛选查看）" id="MyReportQuery"/> 
        </div>  
        <div xid="col12" style="padding-top:5px;"> 
              ...
              <li xid="li2" class="border-Two"> 
                <div component="$UI/system/components/bootstrap/row/row" class="row row-padding"
                  ...
                  <div class="col col-xs-12" xid="col2"> 
                    <img src="$UI/TheSaleEnterprise/WorkReport/img/shizhong.png"
                      alt="" xid="image2" style="width:25px;float:left;"/>  
                    <label xid="label3" bind-text="val(&quot;em_id&quot;)+&quot;(&quot;+val(&quot;em_bm&quot;)+&quot;)&quot;"
                      class="font-One" style="float:left;">label</label>  
                    <div component="$UI/system/components/justep/output/output"
                      class="x-output font-XX" xid="output2" bind-ref="ref(&quot;rq&quot;)"
                      style="float:right;margin-top:-10px;" onRender="output2Render"/> 
                  </div>  
                  ...
                  <div class="col col-xs-12" xid="col1"> 
                    <img src=" " alt="" xid="image1" style="width:80px;height:80px;"
                      bind-attr-src="val(&quot;col4&quot;)" bind-visible="val(&quot;col4&quot;) != undefined"/> 
                  </div>  
