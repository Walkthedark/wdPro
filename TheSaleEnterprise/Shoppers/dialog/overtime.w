...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default1">[{&quot;id&quot;:&quot;1&quot;,&quot;col1&quot;:&quot;加班&quot;,&quot;col2&quot;:&quot;2018021600001&quot;,&quot;col3&quot;:&quot;2018-02-17 15:00 至 2018-02-17 16：00&quot;,&quot;col4&quot;:&quot;0天1小时&quot;,&quot;col5&quot;:&quot;拆分人审批&quot;,&quot;col6&quot;:&quot;2018-02-16 11:44&quot;,&quot;col7&quot;:&quot;李四&quot;}]</data></div> 
  </div>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="newDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/overtimeNew.w"/>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="infoDialog"
    src="$UI/TheSaleEnterprise/Commonly/dialog/overtimeInfo.w"/>  
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-12" xid="col3">
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              ...
                              <label class="x-label font-style" xid="label5"
                                style="width:80px;"><![CDATA[申请人：]]></label>  
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit  font-style" xid="output7"
                                bind-ref='ref("col7")'/>
                            </div>
                          </div>
                          ...
                          <div class="col col-xs-12" xid="col9">
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              ...
                              <label class="x-label" xid="label3" style="width:80px;">加班时间：</label>  
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit" xid="output3" bind-ref="ref(&quot;col3&quot;)"/>
                            </div>
                          </div>  
                          <div class="col col-xs-12 border-Two" xid="col15"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              ...
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit" xid="output5" bind-ref="ref(&quot;col4&quot;)"/> 
                            </div> 
                          </div>  
                          ...
                          <div class="col col-xs-6" xid="col2" style="text-align:right;"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              class="x-label-edit" xid="labelEdit5"> 
                              <label class="x-label" xid="label6"/>  
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit" xid="output4" bind-ref="ref(&quot;col6&quot;)"/>
                            </div> 
                          </div> 
                        </div> 
                      </div> 
