...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column name="product" type="String" xid="column10"></column>
  <column name="feetype" type="String" xid="column1"></column>
  <column name="start" type="String" xid="column2"></column>
  <column name="end" type="String" xid="column3"></column>
  <column name="sn" type="String" xid="column4"></column>
  <column name="cate_id" type="String" xid="column5"></column>
  <column name="type" type="String" xid="xid1"></column></div> 
  </div>  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="infoDialog"
    src="$UI/TheSaleEnterprise/ChannelCost/dialog/activityApprovalInfoCheck.w"/>  
        ...
        <div class="x-panel-top" xid="top1"> 
          <div component="$UI/system/components/justep/row/row" class="x-row border-Two"
            ...
            <div class="x-col" xid="col12" style="text-align:center;"> 
              <label xid="label2" class="font-One" id="netName"><![CDATA[]]></label> 
            </div>  
                    ...
                    <div component="$UI/system/components/justep/row/row" class="x-row mar2"
                      ...
                      <div class="x-col" xid="col17"> 
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-7" xid="col2" style="padding-right:0px;"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                          ...
                          <div class="col col-xs-5" xid="col3" style="padding-right:0px;border-left:1px solid #f0f0f0;"> 
                            <div component="$UI/system/components/justep/labelEdit/labelEdit"
                              class="x-label-edit x-label30" xid="labelEdit1"> 
                              <label class="x-label" xid="label1" style="width:80px;"><![CDATA[活动类型：]]></label>  
                              <div component="$UI/system/components/justep/output/output"
                                class="x-output x-edit" xid="output1" bind-ref='ref("type")'/> 
                            </div> 
                          </div> 
                        </div> 
                      </div> 
