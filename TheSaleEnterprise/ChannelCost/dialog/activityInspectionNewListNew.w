...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      ...
      <column name="qdlx" type="String" xid="xid3"></column>
  <column name="qdzp" type="String" xid="xid4"></column>
  <column name="qdms" type="String" xid="xid5"></column>
  <column name="qddz" type="String" xid="xid6"></column>
  <column name="lat" type="String" xid="xid7"></column>
  <column name="lng" type="String" xid="xid8"></column></div> 
  </div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel3"> 
    <div class="x-panel-top" xid="top3"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar title-one index-title"
        xid="titleBar2" title="新增活动检查"> 
        ...
        <div class="x-titlebar-title" xid="title2">新增活动检查</div>  
    ...
    <div class="x-panel-content" xid="content6"> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row border-One"
        ...
        <div class="x-col" xid="col8"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label3">签到类型：</label>  
          ...
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label1" style="width:80px;">签到描述：</label>  
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"> 
        <div class="x-col" xid="col4"> 
          <div class="imgline" xid="div74" id="activityInspectionNewListImg"> 
            <div class="lfloat simg plusbtn" xid="div57" id="activityInspectionNewListImg1">+
              <input id="uploadactivityInspectionNewList" type="file" class="upfile"
