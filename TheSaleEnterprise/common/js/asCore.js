define(function(require) {
	...
	require("$UI/TheSaleEnterprise/common/js/jq.popForm-1.0");
	require("$UI/TheSaleEnterprise/common/js/jq.popForm-1.0.min");
	require("$UI/TheSaleEnterprise/common/js/w2ui-1.5.rc1.min");
	require("$UI/TheSaleEnterprise/common/js/other");
	var IF = require("$UI/TheSaleEnterprise/common/js/interface");
	// 开发核心js
	var asCore = {};
