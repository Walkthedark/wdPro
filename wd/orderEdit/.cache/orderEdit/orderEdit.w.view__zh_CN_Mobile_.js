...
var __parent0=require('$model/UI2/wd/orderEdit/orderEdit'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cZFjeEn';
	this._flag_='b9ed21e6832776efdeada709ddbbf925';
	this._wCfg_={};
	this._appCfg_={};
