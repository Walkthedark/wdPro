...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="childrenDataFilter" idColumn="cate_id">
   ...
   <column name="children" type="String" xid="column8"></column></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="data1" idColumn="cate_id" onCustomRefresh="data1CustomRefresh">
   <column name="cate_id" type="String" xid="column10"></column>
   <column name="cate_name" type="String" xid="column9"></column>
   <column name="parent_id" type="String" xid="column11"></column>
   <column name="children" type="String" xid="column12"></column></div></div> 
