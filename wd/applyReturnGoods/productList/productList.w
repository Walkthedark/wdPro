...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" title="商品清单" style="background-color:#47D1D1;">
   ...
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li1" style="background-color:#fff;margin-top:10px;"><div xid="div1" style="margin:10px 0;background-color:#fff;">
   <div class="media" xid="media1">
    ...
    <div class="media-body" xid="mediaBody1" style="padding:10px 0;">
     ...
     <div xid="div2" style="padding-top:15px;">
      ...
      <div xid="div5">
       <span xid="span4" style="color:#f66;font-size:14px;">¥</span>
       <span xid="span5" bind-text=' ref("rPrice")' style="color:#f66;"><![CDATA[]]></span></div> </div> </div> </div> 
   <div xid="div6" style="padding:0px 0px 10px;overflow:hidden;">
    <div xid="div7" class="pull-left" style="padding-left:15px;">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" xid="del" icon="linear linear-trash" style="color:#f66;">
    ...
    <div xid="div8" class="pull-right" style="width:70%;padding-right:10px;">
     <div xid="div9" style="display:inline-block;width:92%;">
      <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-sm" tabbed="true" xid="buttonGroup1" style="display:flex;border:1px solid #e6e7e8;width:92%;">
       ...
       <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" style="height:30px;border-top:0;border-bottom:0;text-align:center;" bind-ref='ref("rQuantity")'></input>
     ...
     <span xid="span9" style="flex:1;width:8%;">件</span></div> </div> </div></li></ul> </div></div>
  <div class="x-panel-bottom" xid="bottom1"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="padding:0;">
   ...
   <div class="x-col" xid="col4"><span xid="span10"><![CDATA[共]]></span>
  <span xid="span11"><![CDATA[2]]></span>
  <span xid="span12"><![CDATA[款，总数]]></span>
  <span xid="span13"><![CDATA[6]]></span></div>
   <div class="x-col" xid="col6" style="text-align:right;"><span xid="span14"><![CDATA[金额：]]></span>
  <span xid="span16" style="color:#f66;"><![CDATA[¥]]></span>
  <span xid="span17" style="color:#f66;"><![CDATA[52.46]]></span></div></div></div>
   <div class="x-col x-col-20 x-col-center" xid="col3" style="background-color:#f66;text-align:center;"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="确定" xid="handleListSure" style="background-color:#f66;color:#fff;" onClick="handleListSureClick">
   <i xid="i1"></i>
