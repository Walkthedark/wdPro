...
var __parent0=require('$model/UI2/YUI/login/login'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cyQzEzu';
	this._flag_='2ed46e4fe94034bb182d8f4c5ba6ee90';
	this._wCfg_={};
	this._appCfg_={};
