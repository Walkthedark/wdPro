...
<div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents1">
  ...
  <div class="media" xid="media1">
   <div class="media-left" xid="mediaLeft1">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="服务态度" xid="button6" style="line-height:30px;color:#B1B1B1;font-size:14px;">
   <i xid="i6"></i>
   <span xid="span6">服务态度</span></a></div> 
  ...
  <div class="media-right" xid="mediaRight1">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="满意" xid="button7" style="width:60px;line-height:30px;color:#B1B1B1;font-size:14px;">
   <i xid="i7"></i>
   <span xid="span7">满意</span></a></div></div></div>
  <div xid="div3" class="list-group-item" style="padding:0px 0px 0px 0px;border-top-style:none;">
   <div class="media" xid="media2">
    <div class="media-left" xid="mediaLeft2">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="服务意见" xid="button4" style="line-height:30px;color:#B1B1B1;font-size:14px;">
      <i xid="i3"></i>
      <span xid="span1">服务意见</span></a> </div> 
    <div class="media-body" xid="mediaBody2" style="text-align:center;">
     <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup2">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon btn-color" label="button" xid="button1" icon="dataControl dataControl-star" onClick="button1Click" style="font-size:18px;">
       <i xid="i5" class="dataControl dataControl-star"></i>
       <span xid="span3"></span></a> 
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon btn-color" label="button" xid="button2" icon="dataControl dataControl-star" onClick="button2Click" style="font-size:18px;">
       <i xid="i2" class="dataControl dataControl-star"></i>
       <span xid="span5"></span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon btn-color" label="button" xid="button3" icon="dataControl dataControl-star" onClick="button3Click" style="font-size:18px;">
       <i xid="i12" class="dataControl dataControl-star"></i>
       <span xid="span4"></span></a> 
       
      </div> </div> 
    <div class="media-right" xid="mediaRight2">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="满意" xid="button12" style="width:60px;line-height:30px;color:#B1B1B1;font-size:14px;">
      <i xid="i4"></i>
      <span xid="span2">满意</span></a> </div> </div> </div><div xid="div2" class="list-group-item" style="padding:0px 0px 0px 0px"><textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea1" style="height:200px;background-color:white;border-style:none none none none;" placeHolder="您的评价对维保工人有很大的作用哦！"></textarea></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7" style="position:fixed;bottom:30px;left:0px;">
